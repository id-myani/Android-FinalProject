...
public class QuestionExpertSystem_9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question_expert_system_9);
    ...
    private void nextActivity(int x){
        naiveBayes.setQ9(x);
        Intent intent = new Intent(QuestionExpertSystem_9.this, QuestionExpertSystem_10.class);
