...
public class QuestionExpertSystem_7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question_expert_system_7);
    ...
    private void nextActivity(int x){
        naiveBayes.setQ7(x);
        Intent intent = new Intent(QuestionExpertSystem_7.this, QuestionExpertSystem_8.class);
