...
public class QuestionExpertSystem_8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question_expert_system_8);
    ...
    private void nextActivity(int x){
        naiveBayes.setQ8(x);
        Intent intent = new Intent(QuestionExpertSystem_8.this, QuestionExpertSystem_9.class);
