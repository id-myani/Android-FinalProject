...
public class QuestionExpertSystem_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question_expert_system_2);
    ...
    private void nextActivity(int x){
        naiveBayes.setQ2(x);
        Intent intent = new Intent(QuestionExpertSystem_2.this, QuestionExpertSystem_3.class);
