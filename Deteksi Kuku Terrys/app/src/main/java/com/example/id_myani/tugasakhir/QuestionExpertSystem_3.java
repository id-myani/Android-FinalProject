...
public class QuestionExpertSystem_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question_expert_system_3);
    ...
    private void nextActivity(int x){
        naiveBayes.setQ3(x);
        Intent intent = new Intent(QuestionExpertSystem_3.this, QuestionExpertSystem_4.class);
