...
public class QuestionExpertSystem_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question_expert_system_4);
    ...
    private void nextActivity(int x){
        naiveBayes.setQ4(x);
        Intent intent = new Intent(QuestionExpertSystem_4.this, QuestionExpertSystem_5.class);
