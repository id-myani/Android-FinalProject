...
public class QuestionExpertSystem_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question_expert_system_5);
    ...
    private void nextActivity(int x){
        naiveBayes.setQ5(x);
        Intent intent = new Intent(QuestionExpertSystem_5.this, QuestionExpertSystem_6.class);
