...
public class QuestionExpertSystem_6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question_expert_system_6);
    ...
    private void nextActivity(int x){
        naiveBayes.setQ6(x);
        Intent intent = new Intent(QuestionExpertSystem_6.this, QuestionExpertSystem_7.class);
