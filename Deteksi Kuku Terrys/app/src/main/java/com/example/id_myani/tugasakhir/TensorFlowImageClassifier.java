...
public class TensorFlowImageClassifier implements Classifier {
    ...
    public List<Recognition> recognizeImage(final Bitmap bitmap) {
        ...
        for (int i = 0; i < intValues.length; ++i) {
            ...
            floatValues[i * 3 + 0] = (((val >> 16) & 0xFF) / 256.0f) + (0.5f/256.0f);
            floatValues[i * 3 + 1] = (((val >> 8) & 0xFF) / 256.0f) + (0.5f/256.0f);
            floatValues[i * 3 + 2] = ((val & 0xff) / 256.0f) + (0.5f/256.0f);
        }
        ...
        // Run the inference call.data dalam satu class
